...
const CandidatesEdit = props => {
	...
	const breadcrumbs = [{ active: true, label: 'Kandydaci', href: '/candidates' }, { active: false, label: 'Edytuj kandydata' }];
									...
									</FormControl>
									{
										education === 10 ?
											<Grid container spacing={3}>
												<Grid item xs={1}></Grid>
												<Grid item xs={11}>
													<div className={classes.input_box_label} ><label htmlFor="academic_title">Tytuł naukowy</label></div>
							...
							<Grid container spacing={3}>
								...
								<Grid item md={9} xs={12}>
									...
									<FormControl component="fieldset" error={error.stay_status}>
										<RadioGroup aria-label="Ze względów logistycznych (brak możliwości codziennych dojazdów) deklaruję pobyt stacjonarny w Ośrodku Kompleksowej Rehabilitacji" name="education" value={stay_status} onChange={handleChangeStayStatus} row>
									...
									<div className={classes.error_label} style={{ display: error.employed_status ? 'block' : 'none' }}>Wybierz co najmniej jedną opcję.</div>
									{
										employed_status === 1 ?
											<div>
												...
												<div className={classes.input_box_label}><label htmlFor="occupation">Wykonywany zawód</label></div>
									...
									<div className={classes.error_label} style={{ display: error.disabled_person_status ? 'block' : 'none' }}>Wybierz co najmniej jedną opcję.</div>
									{
										disabled_person_status === 1 ?
											<Grid container spacing={1}>
												<Grid item xs={8}>
													<div className={classes.input_box_label} ><label htmlFor="number_certificate">Numer orzeczenia o niepełnosprawności</label></div>
