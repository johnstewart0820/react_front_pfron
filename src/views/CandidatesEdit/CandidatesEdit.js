		...
		candidate.get(id)
			.then(response => {
				if (response.code === 401) {
					...
					handleChangeVoivodeship(response.data.candidate.voivodeship);
					handleChangeCounty(response.data.candidate.county);
					handleChangeCommunity(response.data.candidate.community);
