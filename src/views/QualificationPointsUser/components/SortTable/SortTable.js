...
const SortTable = (props) => {
  ...
  const {history} = props;
  const { sortBy, sortOrder, requestSort, total, rows, page, selectedCount,searchId, setSearchId, searchType, setSearchType, typeList, searchName, setSearchName, searchAmbassador, setSearchAmbassador, ambassadorList } = props;
  useEffect(() => {
  }, []);
